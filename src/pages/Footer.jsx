  ...
  return (
    <footer className="bg-[#1F2659] text-center mt-12  ">
     ...
     <div className="bg-transparent flex justify-center items-center ">
      ...
      <p className="text-white bg-transparent">Lorem Ipsum is simply dummy text of the printing and  typesetting
     ...
     <Icon className="bg-transparent text-2xl   text-white"  icon="fluent:call-12-filled" />
     <p className="bg-transparent text-white"> 017-0000-0000</p>
     </div>
      </div>
     </div>
        <p className="mt-2">Copyright ©2023 Weero Digital. All rights reserved.</p>
    </footer>
  );
};
